...
import 'package:payapp/data/model/response/error_response.dart';
...
class ApiClient extends GetxService {
  ...
  ApiClient({required this.appBaseUrl, required this.sharedPreferences}) {
    token = sharedPreferences.getString(AppConstants.ecommerceToken) ??
