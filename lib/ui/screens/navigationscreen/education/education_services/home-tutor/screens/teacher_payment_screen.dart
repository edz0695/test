...
class TeacherPaymentWidget extends StatefulWidget {
  const TeacherPaymentWidget({super.key, required this.price});
  final String price;

  @override
  State<TeacherPaymentWidget> createState() => _TeacherPaymentWidgetState();
}

class _TeacherPaymentWidgetState extends State<TeacherPaymentWidget> {
  String body = "";
