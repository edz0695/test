      ...
      if (data) {
        ...
        image = (message.data['image'] != null &&
            ...
            ? message.data['image'].startsWith('http')
                ? message.data['image']
                : '${AppConstants.eComBaseUrl}/storage/app/public/notification/${message.data['image']}'
            : null;
      } else {
        ...
        if (GetPlatform.isAndroid) {
          image = (message.notification!.android!.imageUrl != null &&
              ...
              ? message.notification!.android!.imageUrl!.startsWith('http')
                  ...
                  : '${AppConstants.eComBaseUrl}/storage/app/public/notification/${message.notification!.android!.imageUrl}'
              : null;
          ...
          image = (message.notification!.apple!.imageUrl != null &&
              ...
              ? message.notification!.apple!.imageUrl!.startsWith('http')
                  ...
                  : '${AppConstants.eComBaseUrl}/storage/app/public/notification/${message.notification!.apple!.imageUrl}'
              : null;
        }
      }
