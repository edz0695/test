...
class AppConstants {
  ...
  // BASE URL
  static const String goldAPIBaseUrl = "https://uat-api.augmontgold.com/";
  static const String eComBaseUrl = 'https://6ecom.dealbazaarwale.com';
  static const String sambhavBaseUrl = 'https://xyzabc.sambhavapps.com/v1';

  // GOLD API
  static const String goldRatesAPIUrl = "api/merchant/v1/rates";
  static const String goldProductAPIUrl = "api/merchant/v1/products";
  static const String buyGoldSilverAPIUrl = "api/merchant/v1/buy";
  static const String sellGoldSilverAPIUrl = "api/merchant/v1/sell";
  static const String goldAddToCartAPIUrl = "/gold/cart/add";
  static const String goldGetCartAPIUrl = "/gold/cart";
  static const String goldUpdateRemoveCartAPIUrl = "/gold/cart/item";

  // Education API
  static const String eduFindByAPIUrl = "/education/teacher/findby";

  //SAMBHAV TUBE API
  static const String sambhavTubeCategoriesAPIUrl =
      "$sambhavBaseUrl/st/category";
  static const String sambhavTubeVideoAPIUrl = "$sambhavBaseUrl/st/video";

  //JOB API
  static const String jobsAPIUrl = "$sambhavBaseUrl/job/p1/job/recruiter";
  static const String recruiterJobsAPIUrl =
      "$sambhavBaseUrl/job/p1/job/recruiter";

  // EDUCATION COMMUNITY
  static const String addCommunityCommentsAPIUrl =
      "$sambhavBaseUrl/education/community/post/comment/";
  static const String addCommunityLikeAPIUrl =
      "$sambhavBaseUrl/education/community/post/like/add/";

  // POD URL
  static const String pODProductAPIUrl = "/pod/product/";
  static const String podAddToCartAPIUrl = "/pod/cart/add";
  static const String podGetCartAPIUrl = "/pod/cart";
  static const String podPlaceOrderAPIUrl = "/pod/order";
  static const String podUpdateCartAPIUrl = "/pod/cart/item";
  static const String podRemoveFromCartAPIUrl = "/pod/cart/item";

  // CA Services
  static const String caServicesAPIUrl = "/ca/services";

  // Wallet
  static const String walletBalanceAPIUrl = "$sambhavBaseUrl/user/wallets";
  static const String transactionHistoryAPIUrl =
      "$sambhavBaseUrl/user/transactions?page=1&limit=50";
  ...
  static const String ecommerceToken = '6ammart_token';
  ...
  static const String userEmail = '6ammart_user_email';
