...
import 'package:payapp/view/base/hover/on_hover.dart';
...
class MenuDrawerState extends State<MenuDrawer> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (Get.find<SplashController>().configModel!.toggleStoreRegistration!) {
      _menuList.add(Menu(
        ...
        title: Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
  ...
  Widget _buildContent() {
    return Align(
        alignment:
            Get.find<LocalizationController>().isLtr ? Alignment.topRight : Alignment.topLeft,
        child: Container(
          width: 300,
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
              padding:
                  const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeLarge, horizontal: 25),
