...
import 'package:payapp/data/model/body/translation.dart';
...
import 'package:payapp/view/screens/auth/widget/custom_time_picker.dart';
import 'package:payapp/view/screens/auth/widget/pass_view.dart';
import 'package:payapp/view/screens/auth/widget/select_location_view.dart';
...
class _StoreRegistrationScreenState extends State<StoreRegistrationScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('store_registration'.tr),
        centerTitle: true,
        leading: back(),
        actions: [width(0)],
      ),
