            ...
            Expanded(
              child: TypeAheadField(
                builder: (context, controller, focusNode) {
                  return TextField(
                    controller: isFormAddress
                        ? riderController.formTextEditingController
                        : riderController.toTextEditingController,
                ...
                onSelected: (PredictionModel suggestion) {
                  riderController.setLocationFromPlace(suggestion.placeId,
                      suggestion.description, isFormAddress);
                },
              ),
            ),
            (isFormAddress
                    ? riderController.formTextEditingController.text != ''
