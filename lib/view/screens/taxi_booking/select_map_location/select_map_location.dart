...
import 'package:payapp/helper/rider_type.dart';
...
import 'package:payapp/view/screens/taxi_booking/select_map_location/widgets/rider_address_input_field.dart';
...
class SelectMapLocation extends StatefulWidget {
  ...
  const SelectMapLocation(
      {super.key, required this.riderType, required this.address, this.vehicle});
