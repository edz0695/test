...
import 'package:payapp/view/base/custom_dropdown.dart';
...
import 'package:payapp/view/screens/cart/widget/delivery_option_button.dart';
import 'package:payapp/view/screens/checkout/widget/condition_check_box.dart';
import 'package:payapp/view/screens/checkout/widget/coupon_section.dart';
import 'package:payapp/view/screens/checkout/widget/delivery_instruction_view.dart';
import 'package:payapp/view/screens/checkout/widget/deliveryman_tips_section.dart';
import 'package:payapp/view/screens/checkout/widget/note_prescription_section.dart';
import 'package:payapp/view/screens/checkout/widget/order_successfull_dialog.dart';
import 'package:payapp/view/screens/checkout/widget/partial_pay_view.dart';
import 'package:payapp/view/screens/checkout/widget/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:payapp/view/screens/checkout/widget/payment_section.dart';
import 'package:payapp/view/screens/checkout/widget/time_slot_section.dart';
import 'package:payapp/view/screens/checkout/widget/web_bottom_section.dart';
import 'package:payapp/view/screens/checkout/widget/web_top_section.dart';
import 'package:payapp/view/screens/home/home_screen.dart';
import 'package:payapp/view/screens/store/widget/camera_button_sheet.dart';
    ...
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 2) {
        if (GetPlatform.isWeb) {
          ...
          String selectedUrl;
          selectedUrl =
              '${AppConstants.eComBaseUrl}/payment-mobile?order_id=$orderID&&customer_id=${Get.find<UserController>().userInfoModel!.id}&payment_method=${Get.find<OrderController>().digitalPaymentName}&payment_platform=web&&callback=$protocol//$hostname${RouteHelper.orderSuccess}?id=$orderID&status=';
