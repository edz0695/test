...
import 'package:payapp/view/screens/checkout/widget/payment_failed_dialog.dart';
import 'package:payapp/view/screens/wallet/widget/fund_payment_dialog.dart';
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    if (widget.addFundUrl == '' && widget.addFundUrl!.isEmpty) {
      selectedUrl =
          '${AppConstants.eComBaseUrl}/payment-mobile?customer_id=${widget.orderModel.userId}&order_id=${widget.orderModel.id}&payment_method=${widget.paymentMethod}';
    } else {
  ...
  void _initData() async {
    ...
    browser
        .shouldOverrideUrlLoading(pullToRefreshController as NavigationAction);
