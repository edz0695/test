...
import 'package:payapp/data/model/response/chat_model.dart';
import 'package:payapp/data/repository/chat_repo.dart';
    ...
    if (isRemove) {
      ...
      for (XFile xFile in imageFiles) {
        if (_chatImage.length >= 3) {
          ...
          XFile file = await NetworkInfo.compressImage(xFile);
          _chatImage.add(file);
